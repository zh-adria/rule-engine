...
public class RuleGatewayImpl implements RuleGateway {
    ...
    public List<RuleDefinition> listRules(String category, String businessLine, String status, String keyword) {
        ...
        return ruleRepository.searchRules(category, businessLine, archived, keyword)
                .stream()
                .map(this::toDomain)
    ...
    public List<RuleVersion> listVersions(String ruleCode) {
        return versionRepository.findByRuleCodeOrderByVersionDesc(ruleCode)
                .stream()
                .map(this::toDomain)
                .collect(Collectors.toList());
    }
    ...
    private RuleVersion toDomain(RuleVersionEntity entity) {
        ...
        version.setEffectiveFrom(entity.getEffectiveFrom());
        version.setEffectiveTo(entity.getEffectiveTo());
        return version;
    }
